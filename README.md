...
ensemble-methods/
├── ensembles/
│   ├── boosting.py          # реализация gradient boosting
│   ├── random_forest.py     # реализация random forest
│   ├── utils.py             # вспомогательные функции
│   ├── backend/
│   │   ├── app.py           # FastAPI сервер
│   │   └── schemas.py       # схемы данных
│   └── frontend/
│       ├── client.py        # streamlit интерфейс
│       └── utils.py         # утилиты фронтенда
├── notebooks/
│   ├── ensembles.ipynb      # эксперименты и исследование
│   └── ensembles.zip        # архив с данными для ноутбука
